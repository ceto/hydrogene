...
function tevkori_load_admin_scripts( $hook ) {
	if ($hook == 'post.php' || $hook == 'post-new.php') {
		wp_enqueue_script( 'wp-tevko-responsive-images', get_stylesheet_directory_uri().'/lib/ricg-responsive-images/js/wp-tevko-responsive-images.js', array('wp-backbone'), '2.0.0', true );
	}
}
